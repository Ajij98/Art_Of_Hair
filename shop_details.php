                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        <a href="login.php" class="btn btn-outline-primary py-3"><span>Login for book appointment</span></a>
                        ...
                        <div class="product product-7 text-center shadow" style="border-radius: 5px;">
                            <figure class="product-media">
                                ...
                                <div class="product-action">
                                    <a href="login.php" class="btn-product"><span><i class="fa fa-plus fa-fw"></i> Book Now</span></a>
