                    ...
                    <table id="shop_payment_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td><img src="../owner_panel/<?php echo $result['payment_ss_img']; ?>" height="80"></td>
                              <td><?php echo $result['owner_name']; ?></td>
                              <td><?php echo $result['owner_phone']; ?></td>
                              <td>
							    <?php
                              ...
                              <td>
                                  <?php
                                     ...
                                     if($payment_verify_status == 1)
                                     {
                                      ...
                                      {
                                        ?>
                                        	<a href="shop_payment_verify.php?payment_id=<?php echo $result['payment_id']; ?>" onclick="return confirm('Sure to accept payment?')" class="btn btn-success btn-rounded btn-sm" >Accept Now</a>
                                        <?php
                                      }
                                   ?>
                               </td>
							  <td><?php echo $result['payment_date']; ?></td>
                              <td><a href="delete_data.php?payment_id=<?php echo $result['payment_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
