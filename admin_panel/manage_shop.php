				...
				<div class="content">
                    ...
                    <table id="shop_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td class="text-success font-weight-bold"><?php echo "Shop Id-".$result['shop_id']; ?></td>
                              <td><?php echo 'Shop No-'.$result['shop_no']; ?></td>
                              <td><?php echo $result['shop_name']; ?></td>
                              <td><?php echo $result['shop_verification_code']; ?></td>
                              ...
                              <td>
                                  <?php
                                     ...
                                     if($shop_verify_status == 1)
                                     {
                                      ...
                                      {
                                        ?>
                                        	<a href="shop_verify.php?shop_id=<?php echo $result['shop_id']; ?>" onclick="return confirm('Sure to active shop?')" class="btn btn-success btn-rounded btn-sm" >Make Active</a>
                                        <?php
                                      }
                                   ?>
                               </td>

                              <td><a href="view_shop_details.php?shop_id=<?php echo $result['shop_id']; ?>" title="view shop details" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a> || <a href="delete_data.php?shop_id=<?php echo $result['shop_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
