...
<head>
	...
	<title>Art Of Hair | Customer</title>
				...
				<div class="content">
                    ...
                    <table id="service_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php if($read_customer){ $i = 0; ?>
                            <?php while($result = $read_customer->fetch_assoc()){ $i = $i + 1; ?>
                            <tr>
							  <td class="text-success font-weight-bold"><?php echo "Customer Id-".$result['user_id']; ?></td>
