...
<head>
	...
	<title>Art Of Hair | Manage Area</title>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Area List</div>
                    <div class="card-title float-right d-inline"><a href="add_area.php" class="btn btn-success"><i class="fa fa-plus fa-fw"></i> Add Area</a></div>
									</div>
									<div class="card-body">
                    ...
                    <table id="area_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="update_area_details.php?area_id=<?php echo $result['area_id']; ?>" title="update" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> || <a href="delete_data.php?area_id=<?php echo $result['area_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table.buttons().container()
        .appendTo( '#area_table_wrapper .col-md-6:eq(0)' );
  } );
