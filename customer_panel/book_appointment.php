<?php
 ...
 <!-- Select shop and service details -->
 <?php
  ...
  <!-- Add Booking Details -->
 <?php
   $customer_username = $_SESSION['user_name'];
   ...
   if(isset($_POST['submit']))
   {
         ...
         $booking_verification_code = rand(100000, 999999);



         $sql = "INSERT INTO tb_customer_booking(customer_name,gender,customer_email,customer_phone,customer_address,shop_id,shop_no,shop_name,shop_address,service_id,service_name,service_price,paid_amount,trx_id,paid_by,payment_acc_number,payment_date,booking_verification_code,owner_username,customer_username,entry_time)values('$customer_name','$gender','$customer_email','$customer_phone','$customer_address','$shop_id','$shop_no','$shop_name','$shop_address','$service_id','$service_name','$service_price','$paid_amount','$trx_id','$paid_by','$payment_acc_number','$payment_date','$booking_verification_code','$owner_username','$customer_username','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Your booking submitted successfully. It may take a little while to confirm your booking, please contact with shop owner. Thank You!");
...
<head>
    ...
    <title>Art Of Hair | Book Appointment</title>
                          ...
                          <div class="col-9 m-auto shadow px-4 py-4" style="border-radius: 5px; border-top: 1px solid;">
                            ...
                            <form class="px-3 py-3" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-6">
      			                					<label>Shop Id *</label>
      			                					<input type="text" class="form-control" name="shop_id" value="<?php echo $shop_id; ?>" readonly>
      			                				</div>
      			                			</div>
                                  ...
                                  <div class="row">
      			                				<div class="col-sm-6">
                                      <label>Shop No *</label>
          		            						<input type="text" class="form-control" name="shop_no" value="<?php echo $shop_no; ?>" readonly>
      			                				</div>

                                    <div class="col-sm-6">
                                      <label>Shop Name</label>
          		            						<input type="text" class="form-control" name="shop_name" value="<?php echo $shop_name; ?>" readonly>
      			                				</div>
      			                			</div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <input type="text" class="form-control" name="shop_address" value="<?php echo $shop_address_details; ?>" readonly>
                                    </div>

                                    <div class="col-sm-6">
                                      <label>Service Id</label>
                                      <input type="text" class="form-control" name="service_id" value="<?php echo $service_id; ?>" readonly>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <input type="text" class="form-control" name="service_name" value="<?php echo $service_name; ?>" readonly>
                                    </div>

                                    <div class="col-sm-6">
                                      <label>Service Price</label>
                                      <input type="text" class="form-control" name="service_price" value="<?php echo $service_price; ?>" readonly>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      <label for="gender">Payment Account Number *</label>
                                      <input type="text" class="form-control" name="payment_acc_number" required>
                                    </div>
                                  </div>
