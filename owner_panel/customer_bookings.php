<?php
 ...
 <!-- Customer booking table data load -->
 <?php
   $user_name = $_SESSION['user_name'];
   $db   = new Database();
   $sql  = "SELECT * FROM tb_customer_booking WHERE owner_username = '$user_name'";
...
<head>
	...
	<title>Art Of Hair | Customer Bookings</title>
				...
				<div class="content">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Booking List</div>
									</div>
									<div class="card-body">
                    ...
                    <table id="service_table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                              <th>Booking Id</th>
                              <th>Booking Verification Code</th>
                              <th>Shop Name</th>
                              <th>Shop Address</th>
                              <th>Sevice Name</th>
                              <th>Service Price</th>
                        ...
                        <tbody>
                        	...
                        	<?php if($read_customer_booking){ $i = 0; ?>
                            <?php while($result = $read_customer_booking->fetch_assoc()){ $i = $i + 1; ?>
                            <tr>
							  ...
							  <td>
                                  <?php
                                     ...
                                     if($booking_verify_status == 1)
                                     {
                                      ...
                                      {
                                        ?>
                                        	<a href="customer_booking_verify.php?booking_id=<?php echo $result['booking_id']; ?>" onclick="return confirm('Sure to confirm booking?')" class="btn btn-success btn-rounded btn-sm" > Confirm Booking</a>
                                        <?php
                                      }
                                   ?>
                               </td>

                              <td><a href="view_customer_booking_details.php?booking_id=<?php echo $result['booking_id']; ?>" title="view booking details" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a> || <a href="delete_data.php?booking_id=<?php echo $result['booking_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
