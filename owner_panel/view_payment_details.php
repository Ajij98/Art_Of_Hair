...
<head>
	...
	<title>S & B Care - Customer Payment Details</title>
		...
		<div class="main-header">
			...
			<div class="logo-header">
				<a href="index.php" class="logo">
					<img src="icon/nav_logo.png" class="d-inline py-0 my-0" alt=""> <h5 class="d-inline" style="color: #A3D922;">LuXia</h5><b style="color: #A3D922;">.</b>
				</a>
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Customer Payment Details</h4>
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Payment Details</div>
									</div>
									<div class="card-body">

                    <p>Customer Name: Jhuma</p>
                    <p>Gender: Female</p>
                    <p>Customer Phone: 01847658588</p>
                    <p>Booking Id: Booking Id-1</p>
                    <p>Booking Code: 330615</p>
                    <p>Shop Id: Shop Id-1</p>
                    <p>Shop No: Shop No-3</p>
                    <p>Shop Name: WellNest</p>
                    <p>Shop Type: Salon & Beauty Care</p>
                    <p>Shop Address: Agrabad</p>
                    <p>Service Id: Service Id-1</p>
                    <p>Service Name: Pompadour</p>
                    <p>Service Price: Tk. 350</p>
                    <p>Paid Amount: Tk. 100</p>
                    <p>TrxId: TrxID 8DGY53QUD3</p>
                    <p>Payment Date: 12-02-2021</p>
