...
<head>
	...
	<title>Art Of Hair | Shop List</title>
                    ...
                    <table id="shop_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
							  ...
							  <td><a href="add_shop_services.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-success btn-rounded btn-sm">Add Service</a></td>
                              <td><a href="view_service_details.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-primary btn-rounded btn-sm">View Service</a></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
