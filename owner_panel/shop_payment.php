<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $payment_verification_code = rand(100000, 999999);
         ...
         $sql = "INSERT INTO tb_shop_payment(owner_name,owner_phone,owner_address,shop_id,shop_no,shop_name,shop_address_details,paid_amount,Trx_ID,payment_ss_img,paid_by,payment_acc_number,payment_date,payment_verification_code,payment_added_by,entry_time)values('$owner_name','$owner_phone','$owner_address','$shop_id','$shop_no','$shop_name','$shop_address_details','$paid_amount','$trx_id','$dst_db','$paid_by','$payment_acc_number','$payment_date','$payment_verification_code','$payment_added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Your payment submitted successfully. Thank you!");
    ...
    <div class="main-header">
      ...
      <!-- Sidebar Nav Section End (Section-2) -->
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Shop Payment</h4>
						<div class="row">
							<div class="col-md-6">
								<div class="card">
                    ...
                    <form class="" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="address" rows="3" class="form-control" readonly><?php echo $address; ?></textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="shop_no" name="shop_no" class="form-control" placeholder="Enter Shop No" value="<?php echo $shop_no; ?>" readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
    					...
    					<textarea rows="3" class="form-control" id="shop_address_details" name="shop_address_details" placeholder="Enter Shop Address Details" readonly><?php echo $shop_address_details; ?></textarea>
    				  </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="payment_acc_number" name="payment_acc_number" class="form-control" placeholder="Enter Payment Account Number" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="submit" name="submit" class="btn btn-success" value="Submit Payment">
                      </div>
                    </form>
                      ...
                      <div class="col-12 mb-4 mt-4">
                        <a href="shop_payment.php"><img src="images/payment_method/bkash.svg" height="100" alt="bkash"></a>
                        <p><b>Merchant Number: 01401311811, 01401311812</b></p>
                      </div>

                      <div class="col-12 mb-4">
                        <a href="shop_payment.php"><img src="images/payment_method/nagad.svg" height="100" alt="nagad"></a>
                        <p><b>Merchant Number: 01401311811, 01401311812</b></p>
                      </div>
									</div>
								</div>
