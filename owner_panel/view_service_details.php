 ...
 <?php
   //$user_name = $_SESSION['user_name'];
 	if(isset($_GET['shop_id']))
    {
	 ...
	 $db   = new Database();
	 $sql  = "SELECT * FROM tb_shop_service WHERE shop_id = $shop_id";
	 $read_shop_service = $db->select($sql);
...
<head>
	...
	<title>Art Of Hair | Services</title>
    ...
    <!-- Top Nav Section (Section-1) -->
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Manage Shop Services</h4>
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Service List</div>
									</div>
									<div class="card-body">
                    ...
                    <table id="service_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                        	...
                        	<?php if($read_shop_service){ $i = 0; ?>
                            <?php while($result = $read_shop_service->fetch_assoc()){ $i = $i + 1; ?>
                            <tr>
                              ...
                              <td class="text-success font-weight-bold"><?php echo "Service Id-".$result['service_id']; ?></td>
                              <td><img src="<?php echo $result['service_image'] ?>" height="80"></td>
                              <td><?php echo $result['service_name']; ?></td>
                              <td><?php echo $result['service_price']; ?></td>
                              <td><?php echo $result['service_type']; ?></td>
                              <td><a href="update_service.php?shop_id=<?php echo $shop_id; ?>&service_id=<?php echo $result['service_id']; ?>" title="update" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> || <a href="delete_data.php?shop_id=<?php echo $shop_id; ?>&service_id=<?php echo $result['service_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
