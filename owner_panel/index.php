<?php
 ...
 <!-- Total Shop Payment Count -->
 <?php
     $db   = new Database();
     $sql  = "SELECT * FROM tb_shop_payment";
     $read_shop_payment = $db->select($sql);
     if($read_shop_payment)
     {
       $total_shop_payment = $read_shop_payment->num_rows;
     }
     else
     {
       $total_shop_payment = 0;
     }
    ?>



    <!-- Total Customer Booking Count -->
 <?php
     $db   = new Database();
     $sql  = "SELECT * FROM tb_customer_booking";
     $read_customer_booking = $db->select($sql);
     if($read_customer_booking)
     {
       $total_customer_booking = $read_customer_booking->num_rows;
     }
     else
     {
       $total_customer_booking = 0;
     }
    ?>



    <!-- Total Customer Booking Payment Count -->
 <?php
     $db   = new Database();
     $sql  = "SELECT * FROM tb_customer_booking";
     $read_customer_booking_payment = $db->select($sql);
     if($read_customer_booking_payment)
     {
       $total_customer_booking_payment = $read_customer_booking_payment->num_rows;
     }
     else
     {
       $total_customer_booking_payment = 0;
     }
    ?>
...
<head>
	...
	<title>Art Of Hair | Owner Dashboard</title>
										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<h4 class="card-title"><?php echo $total_shop; ?></h4>
													<a href="manage_shop.php" class="btn text-light">View Details</a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-success">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Shop Payment</p>
													<h4 class="card-title"><?php echo $total_shop_payment; ?></h4>
													<a href="shop_payment_history.php" class="btn text-light">View Details</a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Customer Bookings</p>
													<h4 class="card-title"><?php echo $total_customer_booking; ?></h4>
													<a href="customer_bookings.php" class="btn text-light">View Details</a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-primary">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Booking Payment</p>
													<h4 class="card-title"><?php echo $total_customer_booking_payment; ?></h4>
													<a href="customer_booking_payment_history.php" class="btn text-light">View Details</a>
												</div>
											</div>
										</div>
									</div>
