<?php
 ...
 <?php
   ...
   $db        = new Database();
   $sql       = "SELECT * FROM tb_shop WHERE added_by = '$user_name'";
...
<head>
	...
	<title>Art Of Hair | Manage Shop</title>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Shop List</div>
                    <div class="card-title float-right d-inline"><a href="add_shop.php" class="btn btn-success"><i class="fa fa-plus fa-fw"></i> Add Shop</a></div>
									</div>
									<div class="card-body">

                    <table id="shop_table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                              <th>Shop Id</th>
                              <th>Shop Image</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td><img src="<?php echo $result['shop_image'] ?>" height="80"></td>
							  ...
							  <td><a href="shop_payment.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-primary btn-rounded btn-sm">Shop Payment</a></td>
							  <td><?php echo $result['name']; ?></td>
                              <td><a href="update_shop_details.php?shop_id=<?php echo $result['shop_id']; ?>" title="update" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> || <a href="delete_data.php?shop_id=<?php echo $result['shop_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></td></td>
                            </tr>
                            <?php } ?>
                            <?php }else{ ?>
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#shop_table').DataTable( {
        lengthChange: true,
        buttons: [ 'copy', 'excel', 'pdf', 'colvis' ]
    } );

    table.buttons().container()
        .appendTo( '#shop_table_wrapper .col-md-6:eq(0)' );
  } );
