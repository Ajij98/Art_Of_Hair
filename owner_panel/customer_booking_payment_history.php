<?php
 ...
 <!-- Customer booking payment table data load -->
 <?php
...
<head>
	...
	<title>Art Of Hair | Customer Booking Payment History</title>
    ...
    <!-- Top Nav Section (Section-1) -->
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Customer Booking Payment History</h4>
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title d-inline">Payment History List</div>
									</div>
									<div class="card-body">
...
<script>
  ...
  $(document).ready(function() {
    ...
    table.buttons().container()
        .appendTo( '#payment_table_wrapper .col-md-6:eq(0)' );
  } );
